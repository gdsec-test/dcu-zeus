...
class HostedScribe:
    ...
    def customer_warning(self, ticket, guid, url, report_type, shopper_id):
        ...
        self.crm.notate_crm_account(shopper_id, ticket, crm_note, guid, 'customerWarning')
        return True
    ...
    def suspension(self, ticket, guid, url, report_type, shopper_id):
        ...
        self.crm.notate_crm_account(shopper_id, ticket, crm_note, guid, 'suspension')
        return True
    ...
    def intentionally_malicious(self, ticket, guid, url, report_type, shopper_id):
        crm_note = note_mappings['hosted']['intentionallyMalicious']['crm'].format(guid=guid, type=report_type,
                                                                                   location=url)
        self.crm.notate_crm_account(shopper_id, ticket, crm_note, guid, 'intentionallyMalicious')
        return True
    ...
    def shopper_compromise(self, ticket, guid, url, report_type, shopper_id):
        ...
        self.crm.notate_crm_account(shopper_id, ticket, crm_note, guid, 'shopperCompromise')
        return True
    ...
    def content_removed(self, ticket, guid, url, report_type, shopper_id):
        ...
        self.crm.notate_crm_account(shopper_id, ticket, crm_note, guid, 'contentRemoved')
        return True
    ...
    def repeat_offender(self, ticket, guid, url, report_type, shopper_id):
        ...
        self.crm.notate_crm_account(shopper_id, ticket, crm_note, guid, 'repeatOffender')
        return True
    ...
    def extensive_compromise(self, ticket, guid, url, report_type, shopper_id):
        crm_note = note_mappings['hosted']['extensiveCompromise']['crm'].format(guid=guid, type=report_type,
                                                                                location=url)
        self.crm.notate_crm_account(shopper_id, ticket, crm_note, guid, 'extensiveCompromise')
        return True
