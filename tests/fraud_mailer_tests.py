...
class TestFraudMailer:
    ...
    @patch('zeus.events.email.fraud_mailer.send_mail')
    def test_send_fraud_new_domain_notification(self, send_mail):
        send_mail.return_value = {}
        assert_true(self._mailer.send_new_domain_notification(None, None, None, None, None, 'test-source'))
    ...
    def test_send_fraud_new_domain_notification_exception(self, send_mail):
        ...
        assert_false(self._mailer.send_new_domain_notification(None, None, None, None, None, 'test-source'))
    ...
    def test_send_fraud_new_shopper_notification(self, send_mail):
        send_mail.return_value = {}
        assert_true(self._mailer.send_new_shopper_notification(None, None, None, None, None, 'test-source'))

    @patch('hermes.messenger.send_mail')
    def test_send_fraud_new_shopper_notification_exception(self, send_mail):
        send_mail.side_effect = OCMException()
        assert_false(self._mailer.send_new_shopper_notification(None, None, None, None, None, 'test-source'))
    ...
    def test_send_malicious_notification(self, send_mail):
        send_mail.return_value = {}
        assert_true(self._mailer.send_malicious_domain_notification(None, None, None, None, 'test-source'))

    @patch('hermes.messenger.send_mail')
    def test_send_malicious_notification_exception(self, send_mail):
        send_mail.side_effect = OCMException()
        assert_false(self._mailer.send_malicious_domain_notification(None, None, None, None, 'test-source'))
    ...
    def test_send_new_hosting_account_notification(self, send_mail):
        send_mail.return_value = {}
        assert_true(self._mailer.send_new_hosting_account_notification(None, None, None, None, None, 'test-source'))

    @patch('hermes.messenger.send_mail')
    def test_send_new_hosting_account_notification_exception(self, send_mail):
        send_mail.side_effect = OCMException()
        assert_false(self._mailer.send_new_hosting_account_notification(None, None, None, None, None, 'test-source'))
    ...
    def test_send_malicious_hosting_notification(self, send_mail):
        send_mail.return_value = {}
        assert_true(self._mailer.send_malicious_hosting_notification(None, None, None, None, 'test-source', None))

    @patch('hermes.messenger.send_mail')
    def test_send_malicious_hosting_notification_exception(self, send_mail):
        send_mail.side_effect = OCMException()
        assert_false(self._mailer.send_malicious_hosting_notification(None, None, None, None, 'test-source', None))
